...
// A graph is connected if all vertices are reachable from any one starting vertex.
// Start DFS from node 1, mark all reachable nodes, then check if every node is visited.
