...
// A connected component is a set of vertices reachable from one another.
// Run DFS or BFS from each unvisited vertex and increase count for every new traversal start.
